...
if (process.env.NODE_ENV !== "production") {
  ...
  // In Vercel, static files are handled by the platform via vercel.json rewrites
  // but we can add this for completeness if run in other production environments
